...
<ul class="am-avg-sm-3 am-margin am-padding am-text-center admin-content-list ">
      ...
      <li><a href="#" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>建议预约时间<br/>
      <label id="suggestTime"></label></a></li>
 </ul>
